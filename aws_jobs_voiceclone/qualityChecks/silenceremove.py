...
def read_wave(path):
    ...
    with contextlib.closing(wave.open(path, 'rb')) as wf:
        ...
        return pcm_data, sample_rate, filename
...
def main(args):
    ...
    ## save path 
    filename = os.path.join('/Users/hantswilliams/Documents/development/python_projects/digitalclone-backend/aws_jobs_voiceclone/tts_tests/testdata2/clean_test', filename)
