...
import pyworld
import torch
from functions.audio2head.modules.audio2pose import get_pose_from_audio
from skimage import io, img_as_float32
import cv2
from functions.audio2head.modules.generator import OcclusionAwareGenerator
from functions.audio2head.modules.keypoint_detector import KPDetector
from functions.audio2head.modules.audio2kp import AudioModel3D
...
def audio2head(audio_path, img_path, model_path, save_path):
    temp_audio= "/celery_tasks/functions/audio2head/results/temp.wav"
    ...
    config_file = r"/celery_tasks/functions/audio2head/config/vox-256.yaml"
    ...
    opt = argparse.Namespace(**yaml.safe_load(open("/celery_tasks/functions/audio2head/config/parameters.yaml")))
