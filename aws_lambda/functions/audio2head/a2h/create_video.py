...
def audio2head(audio_path, img_path, model_path, save_path):
    temp_audio= "/var/task/results/temp.wav"
    ...
    config_file = r"/var/task/config/vox-256.yaml"
    ...
    opt = argparse.Namespace(**yaml.safe_load(open("/var/task/config/parameters.yaml")))
